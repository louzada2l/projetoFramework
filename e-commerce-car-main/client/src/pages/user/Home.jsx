  ...
  return (
    <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
      ...
      <section className="px-20 py-20">
        <div className="flex justify-between items-center mb-8 py-20">
        ...
        <form className="flex items-center mt-8 mb-12">
          <div className="relative w-full">
            <input
              ...
              className="text-white outline-none border-none px-4 py-2 rounded-lg w-full placeholder-gray-400 focus:ring-4 focus:ring-indigo-500"
              id="search"
              type="text"
            />
            <button
