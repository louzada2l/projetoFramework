...
const ShoppingCart = () => {
  ...
  // Carregar itens do carrinho e produtos
  useEffect(() => {
    const fetchItems = async () => {
      try {
        ...
        setError(error.message); // Armazenando erro no estado
  ...
  async function createOrder() {
    try {
      ...
      if (data) {
        setItemsCart([]); // Limpar carrinho após pedido
      ...
      <section className="py-24 relative">
        <div className="lg:max-w-7xl 2xl:px-0 lg:px-8 px-16 mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between lg:px-6 pb-6 border-b border-gray-300 max-lg:max-w-lg max-lg:mx-auto">
            ...
            <h6 className="font-bold text-3xl text-green-600">
